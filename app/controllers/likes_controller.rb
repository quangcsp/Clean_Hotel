class LikesController < ApplicationController
  ...
  def create
    ...
    if @like.save
      ...
      subscriber = @review.user
      unless current_user.id==subscriber.id
        Notification.create(subscriber_id: subscriber.id, notifi_user_id: current_user.id, action: 'like', message: '', review_id: @review.id)
      end
      respond_to do |format|
